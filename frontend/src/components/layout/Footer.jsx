    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-sm">
              Connecting you with the best homemade meals from verified home cooks in your neighborhood.
            </p>
        ...
        <div className="border-t border-muted-foreground/20 mt-8 pt-8 text-center text-muted-foreground">
          <p>© 2026 TiffinHub. All rights reserved. Made with ❤️ for homemade food lovers.</p>
        </div>
      </div>
    </footer>
  );
